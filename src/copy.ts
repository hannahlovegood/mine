...
export const copy = {
  ...
  'modes.translate': { en: 'Translated', zh: '译文' },
  ...
  'modes.translate.desc': { en: 'For when the page is in the wrong language.', zh: '当页面不是你的语言。' },
  ...
  'colophon.frag.translated.one': { en: '1 passage translated', zh: '1 段译文' },
  'colophon.frag.translated.many': { en: '{n} passages translated', zh: '{n} 段译文' },
  ...
  'colophon.type.translated': { en: 'Translated', zh: '译文' },
  ...
  'translated.tag': { en: 'Translation', zh: '译文' },
  'translated.beside': { en: 'Translation', zh: '译文' },
  ...
  'ext.apiKey': { en: 'DeepSeek API key', zh: 'DeepSeek API Key' },
  'ext.apiKey.hint': { en: 'Stays in this browser only. Requests go straight from the extension to DeepSeek; nothing passes through us. Leave empty to stay offline.', zh: '只保存在这台电脑的浏览器里，请求由扩展直接发给 DeepSeek，不经过任何第三方。留空即完全离线。' },
  'ext.advanced': { en: 'Advanced', zh: '高级' },
  'ext.translateTo': { en: 'Translate into', zh: '翻译成' },
  'ext.sameLanguage': { en: 'This page is already in that language.', zh: '这个页面已经是这种语言了。' },
  'ext.noModel.translate': { en: 'Translation needs a model. Add an API key under Settings.', zh: '翻译需要模型，请在「设置」里填 API Key。' },
  'ext.baseUrl': { en: 'API base URL', zh: 'API 地址' },
  'ext.model': { en: 'Model', zh: '模型' },
  'ext.server.alt': { en: 'Or a Mine server instead of a key', zh: '或者不填 Key，填一个「由我」服务地址' },
  ...
  'ext.rewriting': { en: 'Rewriting in plain words', zh: '正在改写' },
  'ext.translating': { en: 'Translating', zh: '正在翻译' },
  ...
  'ext.noModel': { en: 'Plain language needs a model. Add a DeepSeek API key under Settings; everything else works offline.', zh: '平实语言需要模型，请在「设置」里填 DeepSeek API Key；其余功能都离线可用。' },
